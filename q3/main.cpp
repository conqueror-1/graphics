...
void DrawCircle (float x, float y,float r, int num_seg )
{
    glBegin(GL_LINE_STRIP);
    for (int i = 0; i < num_seg; i++)
    {
        float angle = 2.0f*3.1415926f * float(i)/float (num_seg);
...
// Function to draw a circle using midpoint
